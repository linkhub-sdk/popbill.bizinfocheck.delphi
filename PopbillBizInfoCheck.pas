...
begin
        ...
        result.corpCode := getJSonIntegerToString(json,'corpCode');
        result.corpScaleCode := getJSonIntegerToString(json,'corpScaleCode');
        result.personCorpCode := getJSonIntegerToString(json,'personCorpCode');
        result.headOfficeCode := getJSonIntegerToString(json,'headOfficeCode');
        ...
        result.establishCode := getJSonIntegerToString(json,'establishCode');
        result.ceoname := getJsonString(json,'ceoname');
        result.workPlaceCode := getJSonIntegerToString(json,'workPlaceCode');
        result.addrCode := getJSonIntegerToString(json,'addrCode');
        ...
        result.result := getJSonIntegerToString(json,'result');
        result.resultMessage := getJsonString(json,'resultMessage');
        result.closeDownTaxType := getJSonIntegerToString(json,'closeDownTaxType');
        result.closeDownTaxTypeDate := getJsonString(json,'closeDownTaxTypeDate');
        result.closeDownState := getJSonIntegerToString(json,'closeDownState');
